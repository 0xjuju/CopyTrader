...
class TestBlockchainExplorer(TestCase):
    ...
    def test_check_balance(self):
        ...
        task = loop.create_task(
            self.explore_polygon.check_balance(contract=contract, abi=self.blok_abi,
                                               wallet_address=wallet_address,
                                               poll_interval=2, old_balance=5405371433.0, handle=h)
            )

        loop.run_until_complete(task)

    def test_convert_from_hex(self):
        num = "0x00000000000000000000000000000000000000000000000000000004a817c800"
        num = self.explore_eth.convert_from_hex(num)
        self.assertEqual(num, 20000)

    def test_convert_to_checksum_address(self):
        address = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xfe\xa8V\x91/ \xbcO|\x87|R\xd6\n,\xdcy|n\xf8'
    ...
    def test_decode_transaction(self):
        # tx = self.explore_eth.get_transaction_receipt("0xdcc9e56836709dcc105314630e26f198b8b8702ad666cbfafe10619e44b8aeeb")
        tx = self.explore_eth.get_transaction_hash_data("0xd17b8893674025481403263047059e90c8b1f6f5d7178b84ed036db283177638")
        data = tx
        ...
        # abi = '[{"inputs":[{"indexed":true,"name":"from","type":"address"},{"indexed":true,"name":"to","type":"address"},{"indexed":false,"name":"value","type":"uint256"}],"name":"Transfer","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"sender","type":"address"},{"indexed":false,"name":"inputToken","type":"address"},{"indexed":false,"name":"outputToken","type":"address"},{"indexed":false,"name":"inputAmount","type":"uint256"},{"indexed":false,"name":"outputAmount","type":"uint256"}],"name":"Swap","type":"event"}]'
    ...
    def test_event_filter(self):
        ...
        print(event.get_all_entries()[0])

    def test_event_listener(self):
        # event_filter = self.explore_eth.custom_filter(from_block="latest", address="0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48")
        contract ="0x229b1b6C23ff8953D663C4cBB519717e323a0a84"
        wallet_address = "0x96167d79e03A37d114FEDb14bD9DeCA2a49ea870"

        # self.explore_eth.event_listener(self.explore_eth.loop_logs, event_filter=event_filter, poll_interval=2)
        def x():
            return 1
        self.explore_polygon.event_listener(self.explore_polygon.check_balance, contract=contract, old_balance=25405371433.0,
                                            abi=self.blok_abi, wallet_address=wallet_address, poll_interval=2, handle=x)

    def test_get_balance_of_token(self):
        contract_address = "0x229b1b6C23ff8953D663C4cBB519717e323a0a84"
        wallet_address = "0x96167d79e03A37d114FEDb14bD9DeCA2a49ea870"
    ...
    #             print(ssock.version())
        ...
        # loop = asyncio.get_event_loop()
        # while True:
        #     loop.run_until_complete(self.explore_eth.get_event())
    ...
    def test_get_contract(self):
        ...
        address = "0xB635A35082616699DC6b93dF891c8dD94d33C103"
        contract = self.explore_eth.get_contract(address, self.generic_pool_abi)
    ...
    def test_get_logs(self):
        ...
        logs = self.explore_eth.get_logs(max_chunk=500, fromBlock=18718170, toBlock=18718181,
                                         address="0x8EE325AE3E54e83956eF2d5952d3C8Bc1fa6ec27")[0]
        abi = '[{"constant":true,"inputs":[],"name":"name","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"symbol","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"decimals","outputs":[{"name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"_owner","type":"address"}],"name":"balanceOf","outputs":[{"name":"balance","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"transfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"_owner","type":"address"},{"name":"_spender","type":"address"}],"name":"allowance","outputs":[{"name":"remaining","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_spender","type":"address"},{"name":"_value","type":"uint256"}],"name":"approve","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"transferFrom","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"anonymous":false,"inputs":[{"indexed":true,"name":"owner","type":"address"},{"indexed":true,"name":"spender","type":"address"},{"indexed":false,"name":"value","type":"uint256"}],"name":"Approval","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"from","type":"address"},{"indexed":true,"name":"to","type":"address"},{"indexed":false,"name":"value","type":"uint256"}],"name":"Transfer","type":"event"}]'

        data = logs["data"]
        topics = [i.hex() for i in logs["topics"]]
        decoded_log = self.explore_eth.decode_log(data=data, topics=topics, abi=abi)
    ...
    def test_get_swap_events(self):
        latest = self.explore_eth.web3.eth.block_number
        start_block = latest - 5000

        address = "0x42E1174AcEbA0bf3b266b2aFBF9c0cb2D8036052"
        contract = self.explore_eth.get_contract(address, self.generic_pool_abi)

        events = self.explore_eth.get_swap_events(contract, start_block, latest)
        for event in events:
            print(event)
    ...
    def test_get_transaction_receipt(self):
        receipt = self.explore_eth.get_transaction_receipt(self.eth_test_hash)
        self.assertIn("blockHash", receipt)
    ...
    def test_paginate(self):
        ...
        self.assertEqual(ranges[-1][1], 25000)
