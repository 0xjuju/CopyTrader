...
ALLOWED_HOST_WEBSITE = config("ALLOWED_HOST_WEBSITE")

ALLOWED_HOSTS = [
    ALLOWED_HOST_WEBSITE,
    NGROK_TEMP_HOST,
    "127.0.0.1",
]
...
ROOT_URLCONF = 'tracker_settings.urls'
...
WSGI_APPLICATION = 'tracker_settings.wsgi.application'
